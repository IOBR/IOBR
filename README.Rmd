...
It is essential that you have R 3.6 or above already installed on your computer or server. IOBR utilizes many other R packages that are currently available from CRAN, Bioconductor and GitHub. 

IOBR is not yet on CRAN or Bioconductor. You can install it from Github:
...
For Chinese users, use the following commands to speed up the package downloading and installation:
