...
### 3.Manual
IOBR pipeline diagram below outlines the data processing flow of this package, and a detailed guidance of how to use IOBR could be find in the [HTML vignette](), or by typing the following code to R session.
