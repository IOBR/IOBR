...
### 3.Manual
IOBR pipeline diagram below outlines the data processing flow of this package, and detailed guidance of how to use IOBR could be found in the [GitHub vignette](https://github.com/IOBR/IOBR/tree/master/vignettes) or [HTML vignette](https://iobr.github.io/IOBR/IOBR-VIGNETTE.html), or by typing the following code to R session.
...
References
---------
DQ Zeng, ZL Ye, GC Yu, …, WJ Liao*, IOBR: Multi-omics Immuno-Oncology Biological Research to decode tumor microenvironment and signatures. bioRxiv, 2020.2012.2014.422647 (2020).[doi: 10.1101/2020.12.14.422647](https://www.biorxiv.org/content/10.1101/2020.12.14.422647v1)
