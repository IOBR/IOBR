...
![IOBR Workflow](./reference/figures/IOBR-Workflow.png)

IOBR Workflow

![IOBR Package](./reference/figures/IOBR-Package.png)
...
| [quanTIseq](http://icbi.at/software/quantiseq/doc/index.md)                 | Free ([BSD](https://github.com/icbi-lab/immunedeconv/blob/master/LICENSE.md))                                 | Finotello, F., et al. (2019). Genome Medicine, 11(1), 34. <https://doi.org/10.1186/s13073-019-0638-6>   |
...
| Method                                                                 | License                                                | Citation                                                                                         |
|------------------------------------------------------------------------|--------------------------------------------------------|--------------------------------------------------------------------------------------------------|
| [GSVA](http://www.bioconductor.org/packages/release/bioc/html/GSVA.md) | Free ([GPL (\>= 2)](https://github.com/rcastelo/GSVA)) | Hänzelmann S, et al. (2013). BMC Bioinformatics, 14, 7. <https://doi.org/10.1186/1471-2105-14-7> |
