...
Use the modern R installation manager rig and package installer pak for
...
- Graphics libraries: libfreetype6-dev, libjpeg-dev, libpng-dev,
  libtiff-dev
...
- Use specific packages instead of meta-packages (e.g., dplyr instead of
  tidyverse)
